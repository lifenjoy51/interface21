...
public class FormatHelper {
     ...
     * @throws Exception 
     */
    public static Node dateTimeElement(long date, String language, String country) throws Exception {
        Locale l = new Locale(language, country);  
        return  dateTimeElement(date, l);
     }
    
    public static Node dateTimeElement (long time) throws Exception {
